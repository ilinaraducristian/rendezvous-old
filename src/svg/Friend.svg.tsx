...
function FriendSVG({isSelected = false}: ComponentProps) {
    return (
        <Svg isSelected={isSelected} width="24" height="24" viewBox="0 0 24 24">
...
const Svg = styled.svg<{ isSelected: boolean }>`
  color: ${props => props.isSelected ? "#fff" : "var(--color-9th)"};
