...
import MessageDto, { ChannelMessageDto, FriendshipMessageDto } from "../dtos/message";
...
export class FriendshipMessage extends Message {
  ...
  async apiDelete() {
    await fetchApi(`friendships/${this.friendshipId}/messages/${this.id}`, "DELETE");
  }
...
export class ChannelMessage extends Message {
  ...
  async apiDelete() {
    await fetchApi(`servers/${this.serverId}/groups/${this.groupId}/channels/${this.channelId}/messages/${this.id}`, "DELETE");
  }
